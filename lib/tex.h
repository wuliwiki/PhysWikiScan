...
// assuming comments and verbatims are already handled
...
// get intervals of \verb command
// for option `i`, only include interval inside \verb`...`
// for option `o`, include from `\` to the closing delimiters
inline void find_verb(Intvs_O intv, Str_I str, Char_I option = 'i')
{
...
// get intervals of \lstinline command
// for option `i`, only include interval inside \lstinline`...`
// for option `o`, include from `\` to the closing delimiters
inline void find_lstinline(Intvs_O intv, Str_I str, Char_I option = 'i')
{
	Long ind0 = 0, ind1, ind2;
	char dlm;
	intv.clear();
