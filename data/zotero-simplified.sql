...
INSERT INTO fields VALUES(6,'date',NULL); -- 发表日期
INSERT INTO fields VALUES(7,'language',NULL); -- 语言

-- 文献属性（和 fields 有何不同？）
CREATE TABLE fieldsCombined (
	fieldID INT NOT NULL,
	fieldName TEXT NOT NULL, -- 属性名
	label TEXT,
	fieldFormatID INT, -- 格式
	custom INT NOT NULL,
	PRIMARY KEY (fieldID)
);
INSERT INTO fieldsCombined VALUES(1,'title',NULL,NULL,0); -- 标题
...
CREATE TABLE itemData (
	...
	fieldID INT, -- fieldsCombined.fieldID
	valueID, -- itemDataValues.valueID
...
CREATE TABLE itemNotes (
	itemID INTEGER PRIMARY KEY, -- 哪篇文献
	parentItemID INT, -- ？
	note TEXT, -- 笔记内容
	title TEXT, -- 笔记标题
	FOREIGN KEY (itemID) REFERENCES items(itemID) ON DELETE CASCADE,
...
CREATE TABLE itemAnnotations (
	itemID INTEGER PRIMARY KEY,
	parentItemID INT NOT NULL, -- 文件附件
